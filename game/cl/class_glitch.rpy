    ...
    """
        ...
        **properties,
        ...
        def render(self, width, height, st, at):
            ...
            theights = sorted(
            randomobj.randrange(int(cheight) + 1) for k in range(nslices)
        )  
            offt = 0  
            fheight = 0  
            while fheight < cheight:
                ...
                if offt and chroma:
                    for color_mask, chponder in (
                    ((False, False, True, True), 1.25),
    ...
    """
        ...
        def render(self, width, height, st, at):
            ...
            self.glitch(
                ...
                cwidth,
                cheight,
                renpy.random.Random(self.randomkey),
                *self.args,
                **self.kwargs,
            ),
            width,
        ...
        @staticmethod
        def glitch(
        child, cwidth, cheight, randomobj, squareside=20, chroma=0.25, permutes=None
    ):
            ...
            for y in range(nrows):
                for x in range(ncols):
                    ...
                    Transform(
                        child,
                        crop=(
                            absolute(x * square_width),
                            absolute(y * square_height),
                            square_width,
                            square_height,
                        ),
                        subpixel=True,
