label palla_desire_0_female:
    call palla_chat_switcher_female ((1, 1, 2, 0, 0)) from _call_palla_chat_switcher_female
    return

label palla_desire_1_female:
    call palla_chat_switcher_female ((1, 1, 1, 2, 0)) from _call_palla_chat_switcher_female_1
    return

label palla_desire_2_female:
    call palla_chat_switcher_female ((1, 1, 2, 3, 1)) from _call_palla_chat_switcher_female_2
    return

label palla_desire_3_female:
    call palla_chat_switcher_female ((1, 1, 1, 2, 2)) from _call_palla_chat_switcher_female_3
    return

label palla_desire_4_female:
    call palla_chat_switcher_female ((1, 1, 0, 1, 2)) from _call_palla_chat_switcher_female_4
    return

label palla_desire_5_female:
    call palla_chat_switcher_female ((1, 1, 0, 1, 3)) from _call_palla_chat_switcher_female_5
    return

label palla_love_0_female:
    call palla_chat_switcher_female ((1, 1, 2, 0, 0)) from _call_palla_chat_switcher_female_6
    return

label palla_love_1_female:
    call palla_chat_switcher_female ((1, 1, 1, 2, 0)) from _call_palla_chat_switcher_female_7
    return

label palla_love_2_female:
    call palla_chat_switcher_female ((1, 1, 2, 3, 1)) from _call_palla_chat_switcher_female_8
    return

label palla_love_3_female:
    call palla_chat_switcher_female ((1, 1, 1, 1, 2)) from _call_palla_chat_switcher_female_9
    return

label palla_love_4_female:
    call palla_chat_switcher_female ((1, 1, 0, 1, 2)) from _call_palla_chat_switcher_female_10
    return

label palla_love_5_female:
    if not palla.flags.gftalk and "palla_event_13" in DONE and palla.status == "girlfriend" and not palla.flags.minealone:
        call palla_chat_gf_talk_female from _call_palla_chat_gf_talk_female
        return

    call palla_chat_switcher_female ((1, 1, 0, 1, 3)) from _call_palla_chat_switcher_female_11
    return

label palla_chat_switcher_female(palla_talk_chances=(1, 1, 2, 0, 0)):
    python:
        ...
        palla_talk_hooks = ('palla_chat_love_female', 'palla_chat_sex_female', 'palla_chat_bitchy_female', 'palla_chat_cautious_female', 'palla_chat_sexy_female')
        test = 0
        for i in range(0, 5):
...
label palla_chat_bitchy_female:
    $ result = randint(1, 8)
    if result == 1:
...
label palla_chat_cautious_female:
    $ result = randint(1, 5)
    if result == 1:
        palla.say "If you weren't a little bit sexy, I wouldn't have anything to do with you."
        bree.say "Wait, was that supposed to be a compliment?"
        palla.say "Not really."
        bree.say "But you think I'm sexy?"
        ...
        bree.say "I don't know. Take care of your kids?"
        ...
        bree.say "Ouch! Now what did I ever do to give you that impression?"
        palla.say "I can just tell. I can see into your black, evil soul."
        bree.say "Well, for your information, Miss Know-it-all, I'd like children. With the right person, of course."
        palla.say "What's the right person?"
        bree.say "I don't know. Someone who's hot, obviously. Knows what she wants. Smart. Successful. Funny. You know."
        palla.say "So not really any of the bitches you hang out with."
        bree.say "Did you just self-own?"
        palla.say "Oh. Okay not MOST of the bitches you hang out with."
        bree.say "For the record, I did NOT just say I want to have kids with you."
        ...
        bree.say "No, I don't think you have."
        palla.say "Good because I'm not sure you'd want to know them. They certainly wouldn't want to know you."
        bree.say "Damn, you can be a bitch sometimes."
        palla.say "So?"
        bree.say "So now you've got me curious, because I never thought of you as having a family. I kinda thought of you as having emerged from the ooze, fully formed, ready to give the world the finger."
        palla.say "Huh. Better than what I got, I guess. Except maybe my little sister, she's okay. Fuck the rest of them though."
        bree.say "Seriously, is there anybody you like?"
        palla.say "My sister. Audrey. My agent, I guess."
        bree.say "I know I'll regret saying this, but you left me out of that list."
        palla.say "Yes, yes I did."
        bree.say "Why do you talk to me again?"
        ...
        bree.say "Oh yes, I've noticed."
        palla.say "Anyway, um, thanks."
        bree.say "Um, yeah. You're welcome?"
        palla.say "So why do you put up with me, anyway?"
        bree.say "Are you drunk?"
        palla.say "Maybe. Maybe not. Answer the question."
        bree.say "I don't know. Maybe it's because every once in awhile, between being a bitch and a mega bitch, you say something sweet."
        palla.say "Uh huh."
        bree.say "And maybe it's because you've got nice tits."
        palla.say "At least you're consistent."
        $ palla.love += 1
    return

label palla_chat_sexy_female:
    $ choices = 3
    ...
    if result == 1:
        ...
        bree.say "I'll get in trouble if I say yes, won't I?"
        palla.say "Absolutely."
        menu:
            "It's the tits. And the ass.":
                bree.say "It's not just about your tits. You also have a sexy ass. And legs. Actually you're sexy from top to bottom."
                palla.say "That's...a nice save."
                $ palla.love += 1
            "I actually like you":
                bree.say "Okay Palla, I'll bite. I hang out with you because I actually like you."
                palla.say "But I'm a grade A bitch."
                bree.say "A {b}sexy{/b} grade A bitch, and I also know what's really under there."
                palla.say "Oh. Oh. Um. Oh!"
                bree.say "What's the matter, cat got your tongue?"
                palla.say "I guess I wasn't expecting you to say something nice."
                $ palla.love += 2
            "I like a woman on her knees" if palla.sub > 40:
                bree.say "I like a woman on her knees. I like a bitch who can be my bitch. You know?"
                palla.say "And you think I'm your bitch?"
                if palla.sub > 80 or palla.is_sex_slave:
                    bree.say "Yeah, you're my bitch, Bitch."
                else:
                    bree.say "Not yet. I know I haven't earned it yet. But I will."
                "Palla shivers."
                $ palla.sub += 2
    elif result == 2:
        ...
        bree.say "Ouch, my ego is bruised. No really."
        ...
        menu:
            "Both in my arms, you on your knees":
                bree.say "Better. One of them in each arm, and you on your knees."
                palla.say "Um. Yeah I better go and, um. Fix my makeup."
                $ palla.sub += 1
            "Damn that's hot":
                bree.say "Damn that's hot. Also I'm afraid if I admit it you're going to go \"{b}hah{/b} just kidding what an asshole!\""
                palla.say "Me??"
                bree.say "Yes, you."
                ...
                $ palla.love += 1
            "I'd never!":
                bree.say "I'd never do anything like that."
                ...
                if bree.sexperience < 1 and sasha.sexperience < 1 and audrey.sexperience < 1:
                    ...
                    menu:
                        "Sure":
                            bree.say "Sure, I'll get right on that."
                            $ palla.love += 1
                        "I don't want a harem":

                            bree.say "I'm just not interested in a harem. What kind of guy do you think I am?"
                            palla.say "I dunno, I guess I thought you were interesting."
                            $ palla.love -= 1
                        "I only want you":
                            bree.say "You're the only woman I want."
                            "Palla nearly chokes."
                            palla.say "Seriously, [hero.name]?"
                            bree.say "Yeah, seriously!"
        ...
        bree.say "It would be weird if you didn't since we keep doing it."
        ...
        bree.say "To be fair you like it when I hurt you."
...
label palla_chat_love_female:
    bree.say "What's your take on love?"
    if palla.love < 40:
        ...
        bree.say "Do you want to talk about it?"
        palla.say "Fuck off."
        bree.say "That's a no, then."
        $ palla.love -= 1
    elif palla.love < 80:
        ...
        bree.say "Damn, Palla, that's depressing."
        ...
        bree.say "Huh, I don't remember ever hearing about that last part."
        palla.say "It's what the witches used to do."
        bree.say "Oh, that explains it. You're definitely a witch."
        ...
        bree.say "Am I supposed to say something?"
        ...
        bree.say "Yeah, I like you too."
        palla.say "{b}Like{/b}?!"
        bree.say "Fine, I think you're a hot, sexy charming bitch and I love fucking you, and hanging out with you."
        palla.say "And dancing?"
        if hero.has_skill("dance"):
            bree.say "Oh fuck yeah, the dancing might be the best part."
            palla.say "I guess that'll do."
        else:
            bree.say "Oh and the dancing too, I guess. But really it's the fucking."
            palla.say "[hero.name], you're as romantic as a tractor. A sexy tractor, but a tractor nonetheless."
            bree.say "You say the sweetest things, bitch!"
        $ palla.love += 1
    else:
        if palla.is_sex_slave:
            palla.say "I'm definitely in love with you. And only you, Master."
            bree.say "I love you too, my sexy, sassy slave."
            ...
            bree.say "You're the best thing that's ever happened to me."
...
label palla_chat_sex_female:
    bree.say "What's your take on sex?"
    if palla.love < 40:
        if hero.grooming < 6:
            palla.say "Don't talk about sex, you smell like the sewer backed up."
            if game.room != palla.room:
                bree.say "How do you know that on the phone?"
        ...
        if result == 1:
            ...
            bree.say "I'm pretty sure I didn't want to hear about another guy you fucked."
            palla.say "Too bad, it's part of the package. Don't want hear about it, don't ask."
            bree.say "Ugh, you're such a bitch."
            ...
            bree.say "Yeah, but tell me more about the blonde!"
            "Palla looks at me sideways."
            palla.say "What, do you want to hear that we went back to the hotel and had hot hot lesbian sex?"
            bree.say "Yes, I'd like to hear that you went and had hot hot lesbian sex."
            palla.say "Maybe we did, maybe we didn't. I ain't tellin'."
            bree.say "Damn, that actually was going to be a pretty good story too, right until the end."
            ...
            bree.say "Fuck, Palla, have you {b}seen{/b} your tits?"
            palla.say "Well, yeah, they're hot."
            bree.say "Well, there you go!"
...
label palla_chat_gf_talk_female:
    ...
    bree.say "Huh."
    bree.say "So, does that mean you want to be exclusive?"
    palla.say "No!"
    bree.say "You're not convincing me."
    "Silence."
    bree.say "So?"
    palla.say "I mean, exclusive with you? Gross."
    bree.say "Nice. I mean I know you feel free to speak your mind, but my ego isn't unbreakable."
    ...
    menu:
        "Yes!":
            bree.say "I...yeah, I kind of do."
            $ palla.flags.minealone = True
            palla.say "Well. We'll see, I guess."
            bree.say "Oh no, don't you dare pull that bullshit on me. You don't get to ask that and weasel out of it if I answer wrong."
            palla.say "Oh my God! You're so needy!"
            bree.say "Yeah, fuck you too. So that settles it, you're not seeing anyone else now."
            palla.say "Uh. Did I say that?"
            bree.say "You're about to."
            palla.say "Stop telling me what to do!"
            bree.say "Palla..."
            palla.say "Fine. I won't see anyone else. I wasn't going to, anyway. There, happy?"
        "No":
            bree.say "Well, you're not seeing anyone else anyway, so it looks like there's no real competition anyway."
            palla.say "Full of yourself, aren't you?"
            bree.say "You're the one full of me, babe."
            palla.say "Ugh. Just for that, I'm going to find someone and go out. I'll suck the guy off {b}just{/b} for that stupid line."
            bree.say "Yeah, and you'll be thinking of me the whole time."
