    ...
    class CG_BeachVolleyball_Picker(object):
        def __call__(self, attr):
            ...
            if g:
                ...
                if g.id in ["cassidy", "aletta", "hanna", "master", "scottie", "mike", "victor", "dwayne", "kat", "amy", "reona"]:
...
init 1:
    layeredimage beach volleyball:
        ...
        group navel auto if_any ["navel"] if_not ["backmc"]
        ...
        group swimsuit auto if_any ["swimsuit"] if_not ["backmc", "boobjob", "naked"]
        group swimsuit auto variant "bb" if_all ["swimsuit", "boobjob"] if_not ["backmc", "naked"]

        attribute sexyswimsuit null
        group sexyswimsuit auto if_any ["sexyswimsuit"] if_not ["backmc", "boobjob", "naked"]
        group sexyswimsuit auto variant "bb" if_all ["sexyswimsuit", "boobjob"] if_not ["backmc", "naked"]
        ...
        group navel auto if_any ["navel"] if_not ["frontmc"]

        group eyebrow auto if_any ["eyebrow"] if_not ["frontmc"]

        group swimsuit auto if_not ["sexyswimsuit", "frontmc", "boobjob", "naked"]

        group sexyswimsuit auto if_any ["sexyswimsuit"] if_not ["frontmc", "boobjob", "naked"]
