...
init 1:
    layeredimage beach sandcastle:
        ...
        group npc auto variant "nopregnant" if_not ["alonemc"]
        ...
        group mcoutfits auto variant "breemc_left_01" if_all ["breemc", "01", "left"] if_not ["mc_naked"]
        ...
        group mchaircuts auto variant "breemc_right_01" if_all ["breemc", "01", "right"]:
            attribute mc_nohaircut null
        group mcoutfits auto variant "breemc_right_01" if_all ["breemc", "01", "right"] if_not ["mc_naked"]
        ...
        group outfits auto variant "nopregnant" if_not ["alonemc", "naked"]
        ...
        group mchaircuts auto variant "breemc_02" if_all ["breemc", "02"]:
            attribute mc_nohaircut null
        group mcoutfits auto variant "breemc_02" if_all ["breemc", "02"] if_not ["mc_naked"]
