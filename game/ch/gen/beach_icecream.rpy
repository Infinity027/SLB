...
init 1:
    layeredimage beach icecream:
        ...
        group swimsuit auto if_not ["sexyswimsuit", "naked",  "boobjob"]
        group sexyswimsuit auto if_any ["sexyswimsuit"] if_not ["naked",  "boobjob"]
        ...
        group outfit auto variant "morgan" if_any ["morgan"] if_not "naked"
