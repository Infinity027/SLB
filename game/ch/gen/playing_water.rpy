...
init 1:
    layeredimage playing water:
        attribute_function MultiPickers([CG_PlayingWater_Picker, CollarPicker, HaircutPicker, OutfitPicker,  PubesPicker, MCCGPicker], use_morgan_cg_outfits=True, append_npc_from_attributes=True, add_simple_pregnant_attribute=True)
