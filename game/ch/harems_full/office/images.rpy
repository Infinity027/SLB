init 1:
    layeredimage office aletta foursome:
        attribute_function Pickers([CollarPicker], npc=aletta)
    ...
    layeredimage office lavish foursome:
        attribute_function Pickers([CollarPicker], npc=lavish)
    ...
    layeredimage office shiori foursome:
        attribute_function Pickers([CollarPicker], npc=shiori)
    ...
    layeredimage office sixsome:
        attribute_function MultiPickers([CollarPicker], npcs=[audrey, lavish, shiori] )
    ...
    layeredimage office threesome shiorifuck audrey:
        attribute_function MultiPickers([CollarPicker,  DickPicker, PubesPicker], npcs=[audrey, shiori])
        attribute aud null
        attribute anal null
    ...
    layeredimage office threesome lavishfuck audrey:
        attribute_function MultiPickers([CollarPicker,  DickPicker, PubesPicker], npcs=[audrey, lavish])
    ...
    layeredimage office threesome shiorifuck lavish:
        attribute_function MultiPickers([CollarPicker,  PubesPicker], npcs=[lavish, shiori])
    ...
    layeredimage office threesome lavishfuck shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker, PubesPicker], npcs=[lavish, shiori])
    ...
    layeredimage office cumshare audrey lavish:
        attribute_function MultiPickers([CollarPicker,  DickPicker], npcs=[audrey, lavish])
    ...
    layeredimage office cumshare audrey shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker], npcs=[audrey, shiori])
        attribute cum null
        attribute cumshot null
    ...
    layeredimage office cumshare lavish shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker], npcs=[lavish, shiori])
    ...
    layeredimage office ending:
        attribute_function MultiPickers([CollarPicker,  OutfitPicker], add_simple_outfit_attribute=True, append_npc_from_attributes=True)
        attribute work null
    ...
    layeredimage office foursome cumshare audrey lavish shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker], npcs=[audrey, lavish, shiori])
    ...
    layeredimage office foursome lavishfuck audrey shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker, PubesPicker], npcs=[audrey, lavish, shiori])
    ...
    layeredimage office fivesome alettafuck audrey lavish shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker, HaircutPicker], npcs=[aletta, audrey, lavish, shiori])
        attribute cum null
        attribute condom null
    ...
    layeredimage office fivesome lavishfuck aletta audrey shiori:
        attribute_function MultiPickers([CollarPicker,  DickPicker, HaircutPicker, PubesPicker], npcs=[aletta, audrey, lavish, shiori])
