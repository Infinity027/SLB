init 1:
    layeredimage band threesome:
        attribute_function MultiPickers([CollarPicker,  HaircutPicker, PubesPicker, DickPicker, XrayPicker], npcs=[kleio], append_npc_from_attributes=True)
    ...
    layeredimage bus_tour:
        attribute_function MultiPickers([CollarPicker,  HaircutPicker], npcs=[anna, kleio, sasha])
        always:
            "bus_tour_bg"
    ...
    layeredimage picnic:
        attribute_function MultiPickers([CollarPicker,  HaircutPicker, EndingKidPicker], npcs=[anna, kleio])
        always:
            "picnic_bg"
    ...
    layeredimage band foursome:
        attribute_function MultiPickers([DickPicker, HaircutPicker, CollarPicker,  PubesPicker], npcs=[anna, kleio, sasha])
    ...
    layeredimage band foursome2:
        attribute_function MultiPickers([DickPicker, HaircutPicker, CollarPicker], npcs=[anna, kleio, sasha])
