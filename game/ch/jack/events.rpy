init python:
    ...
    Event(**{
    "name": "jack_react_kylie_sentence",
    "priority": 1500,
    "label": "jack_react_kylie_sentence",
    "conditions": [
    ...
    Event(**{
    "name": "jack_murder_talk",
    "priority": 1400,
    "label": "jack_murder_talk",
    "conditions": [
        HeroTarget(
            IsGender("male"),
            HasRoomTag("street"),
...
label jack_murder_talk:
    show jack sad at center, zoomAt(1.0, (1040, 780)) with dissolve
    "Jack seems to have been keeping his distance from me a little since the incident with Kylie happened."
    show jack sad at center, traveling(1.0, 1.0, (940, 780))
    "But I don't know if that's on account of him wanting to give me some space to process everything."
    show jack sad at center, traveling(1.0, 1.0, (840, 780))
    "Or if it's because he feels awkward seeing me with all of that stuff fresh in his mind."
    show jack sad at center, traveling(1.0, 1.0, (740, 780))
    "From my what I know if Jack, it's more likely to be the latter than the former."
    show jack sad at center, traveling(1.5, 1.0, (640, 1120))
    "And when he finally shows up to see me, it doesn't take long for him to prove me right."
    jack.say "Ah..."
    jack.say "Hey man..."
    mike.say "Oh..."
    mike.say "Hey, Jack."
    jack.say "How are you doing, buddy?"
    jack.say "I mean, are you okay?"
    "As soon as the words are out of his mouth, Jack seems to realise his mistake."
    "He instantly starts shaking his head and waving his hands in the air."
    show jack surprised
    jack.say "Shit..."
    show fx exclamation
    jack.say "I didn't mean that, [hero.name]!"
    jack.say "Of course you're not okay - how could you be?"
    show jack sad
    "I could get a lot of gratification out of just how embarrassed Jack is right now."
    "But I'm not that kind of person, and he's someone I consider to be a good friend."
    "Plus I can tell from the tone of his voice that he's one hundred percent serious."
    "So I do all that I can to pull him out of the hole he's dug for himself."
    mike.say "It's okay, Jack..."
    mike.say "I know what you really meant to say."
    "Jack looks instantly relieved."
    "Like he finally believes that he's off the hook."
    jack.say "Phew..."
    show jack normal
    jack.say "Thanks, buddy!"
    "I watch as Jack's entire body seems to relax, almost like the air's been let out of him."
    "And when he starts talking again, he sounds pretty much like his normal self."
    if kylie.flags.rape and (not kylie.flags.killed == 'bree' and not kylie.flags.killed == 'sasha'):
        jack.say "So..."
        jack.say "What happened to you really sucks."
        "That kind of seems like the understatement of the century to me."
        "But I already know that Jack's struggling to know what to say."
        "So there doesn't seem to be any point in pulling him up on it."
        mike.say "You could say that."
        mike.say "It definitely sucked from my point of view."
        "Jack nods in agreement."
        "But then he goes silent again for a moment."
        "Almost like he's having to process everything that I've said."
        "Which makes his next comment that much harder to understand."
        jack.say "It's weird though..."
        jack.say "Because as a guy..."
        show fx question
        jack.say "You kind of wonder what it'd be like, you know?"
        jack.say "For a hot girl to just like, not give you a choice!"
        "I can't help wincing at what Jack just said."
        "Not only because it's in pretty bad taste."
        "But also because it takes me straight back to what happened."
        mike.say "Ouch..."
        show jack sad
        mike.say "That's kind of a dumb thing to say, Jack!"
        mike.say "Just take it from me - it's not as fun as you might think."
    elif not kylie.flags.rape and (kylie.flags.killed == 'bree' or kylie.flags.killed == 'sasha'):
        if kylie.flags.killed == 'bree':
            jack.say "I just can't believe what happened to Bree either!"
        elif kylie.flags.killed == 'sasha':
            jack.say "I just can't believe what happened to Sasha either!"
        jack.say "Like, I'm never going to be able to see her again."
        "I nod, beginning to feel the pain of that loss start to return."
        "The truth is that I'm not even close to making sense of it myself."
        mike.say "Me too, Jack."
        mike.say "I'd gotten so used to having her around."
        mike.say "And she was more than just a housemates to me as well."
        mike.say "She was a true friend."
        jack.say "Oh yeah, man!"
        show jack sad
        jack.say "I always hoped that, one day, she'd be more than friend to me too."
        "I can't help shaking my head at the way Jack chose to phrase that."
        "As if even now he can't help but let slip the fact that he had a thing for her."
        jack.say "But you have to say one thing for Kylie."
        mike.say "You do?"
        show jack normal
        jack.say "Yeah, she was a terrible girlfriend."
        jack.say "But as far as psychos go - she's totally killing it!"
        mike.say "Jesus Christ, Jack!"
        show jack sad
        jack.say "What's the matter?"
        show fx question
        jack.say "Too soon?"
        mike.say "It's never going to be the right time for jokes like that!"
        ...
        mike.say "That's kind of a dumb thing to say, Jack!"
        mike.say "Just take it from me - it's not as fun as you might think."
        "Jack suddenly looks more nervous than ever."
        "And he seems to be casting about too."
        "Like he's looking for a way to change the subject."
        if kylie.flags.killed == 'bree':
            jack.say "I just can't believe what happened to Bree either!"
        elif kylie.flags.killed == 'sasha':
            jack.say "I just can't believe what happened to Sasha either!"
        ...
        jack.say "Too soon?"
        mike.say "It's never going to be the right time for jokes like that!"
    "I feel the need to take control of the situation here."
    "To begins steering the conversation in a safer direction."
    "Before Jack finally says something too awful to take back or be forgiven."
    mike.say "Anyway..."
    mike.say "At least we know that Kylie's safely behind bars."
    show jack normal
    "Jack nods, sensing my efforts to change the subject."
    jack.say "Oh, totally, man, totally..."
    jack.say "She might have been super-hot."
    show fx exclamation
    jack.say "But she was a super-psycho too!"
    mike.say "Thanks for that, Jack..."
    mike.say "I couldn't have put it better myself."
...
label jack_react_kylie_sentence:
    jack.say "Hey!"
    show jack angry at mostright5, dark with easeinright
    jack.say "Hey, [hero.name]…"
    show jack at mostright4, dark with ease
    jack.say "Is it true?!?"
    "I look up the moment I hear the familiar sound of Jack's voice."
    "And that's when I see him, hurrying towards me with his hands in the air."
    "A quick glance around me shows there's nowhere I can hide and no means of escape."
    "So I guess the only thing that I can do is stand right where I am as he hurries over."
    "I guess I should have expected this to happen."
    "Ever since Kylie was sentenced, people have been tracking me down."
    "Some of them to ask how I'm coping with it."
    "But most of them to tell me all about how they feel instead."
    hide jack
    show jack angry at mostright4
    with dissolve
    "And Jack's never been the subtlest of guys."
    "So he was going to track me down sooner or later."
    show jack sad at center with ease
    mike.say "Hey, Jack..."
    mike.say "No time to ask me how I'm doing?"
    mike.say "Not going to ask where my head is right now?"
    mike.say "Just straight down to the business of the death sentence, yeah?"
    "To his credit, my words seem to have an instant effect on Jack."
    "His expression quickly becomes self-conscious and embarrassed."
    show fx drop
    jack.say "Yeah..."
    jack.say "No..."
    jack.say "I mean..."
    "The pleasure of catching Jack off-guard doesn't last too long."
    "And pretty soon I feel like I have to let him off the hook."
    "So I shake my head and take a more sympathetic tone."
    hide fx
    mike.say "It's okay, Jack..."
    mike.say "There's no easy way to say it."
    mike.say "So maybe just being up front is the best thing."
    show jack normal
    "Jack nods at this, starting to look a little less worried."
    "But when he speaks, it's clear that he's making more of an effort."
    jack.say "I did mean it, [hero.name]…"
    jack.say "I really was asking if it's true."
    jack.say "Everyone's saying it, but I didn't see it on the news or anything."
    "I shrug and let out a sigh."
    "Then I nod my head."
    mike.say "Yeah, Jack..."
    mike.say "It's totally true."
    mike.say "They found Kylie guilty, one hundred percent."
    mike.say "And she's been sentenced to death!"
    show jack sad
    "Jack nods slowly, as if the reality is only just starting to sink in."
    show jack angry
    "For a few seconds, his mouth hangs open and he's totally silent."
    "And I think that he might actually have been left speechless."
    "But then he seems to blink and shake his head, like his brain's rebooting."
    show jack sad
    jack.say "Whoa..."
    jack.say "This is all so crazy, dude!"
    jack.say "It's like we're living inside a movie or something."
    mike.say "Yeah, a horror movie!"
    mike.say "One that never seems to end too."
    "Now Jack's shaking his head, and the reality seems to be sinking in for him."
    "Who knows, maybe he's finally coming to terms with everything that's happened."
    "Maybe he's about to come out with some idiot savant wisdom that'll help me out too."
    jack.say "Yeah..."
    show jack angry
    jack.say "It's a hell of a mess, dude."
    jack.say "And the worst thing is that Kylie was so hot!"
    mike.say "Huh?"
    show jack normal
    jack.say "You know she was, man!"
    show jack perv
    jack.say "I would have loved to be able to put my dick in crazy, just once."
    jack.say "And she was a grade A, certified lunatic!"
    "I roll my eyes and shake my head, totally amazed at what I'm hearing."
    mike.say "Seriously, Jack?"
    show fx question
    show jack surprised
    jack.say "What?"
    mike.say "Not cool, seriously, not cool!"
    hide fx
    return
return
