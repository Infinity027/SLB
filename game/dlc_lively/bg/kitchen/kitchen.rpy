...
init 6:
    layeredimage bg kitchen:
        ...
        group bree_top auto when bree and not (bree_topless or bree_naked)
        group bree_top auto variant nopreg when bree and not (bree_topless or bree_naked)
        ...
        group sasha_top_bb auto when sasha and sasha_boobjob and not (sasha_topless or sasha_naked)
        group sasha_top_nobb auto when sasha and sasha_noboobjob and not (sasha_topless or sasha_naked)
        group sasha_hair auto when sasha
        attribute sasha_collar when sasha

        attribute lexi
        attribute lexi_collar when lexi
        group lexi_bot auto when lexi and not (lexi_bottomless or lexi_naked)
        group lexi_bot auto variant nopreg when lexi and not (lexi_bottomless or lexi_naked)
        group lexi_top auto when lexi and not (lexi_topless or lexi_naked)
        attribute lexi_nohaircut when lexi

        attribute minami
        attribute minami_collar when minami
        group minami_bot auto when minami and not (minami_bottomless or minami_naked)
        group minami_bot auto variant nopreg when minami and not (minami_bottomless or minami_naked)
        group minami_top auto when minami and not (minami_topless or minami_naked)
        group minami_top auto variant nopreg when minami and not (minami_topless or minami_naked)
