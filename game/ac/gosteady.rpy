...
label go_steady:
    ...
    if renpy.has_label(f"{active_girl.id}_go_steady_intro_male"):
        ...
        call expression f"go_steady_dialogues_1_male" from _call_expression_89
    if active_girl.love >= 150:
        $ renpy.show(f"{active_girl.id} happy")
        if renpy.has_label(f"{active_girl.id}_go_steady_yes_male"):
            call expression f"{active_girl.id}_go_steady_yes_male" from _call_expression_91
        else:
        ...
        if renpy.has_label(f"{active_girl.id}_go_steady_no_male"):
            call expression f"{active_girl.id}_go_steady_no_male" from _call_expression_93
        else:
