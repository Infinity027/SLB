init 1:
    layeredimage thot 3some blowjob:
        attribute_function MultiPickers([CollarPicker,  HaircutPicker, MCCGPicker], npcs=[alexis, reona])
    ...
    layeredimage thot 3some handjob:
        attribute_function MultiPickers([ HaircutPicker, MCCGPicker], npcs=[alexis, reona])
    ...
    layeredimage thot 3some fuckreona:
        attribute_function MultiPickers([ HaircutPicker, PubesPicker, MCCGPicker], npcs=[alexis, reona])
    ...
    layeredimage thot 4some fuckalexis:
        attribute_function MultiPickers([ CollarPicker, PubesPicker, DickPicker], npcs=[alexis, reona], append_npc_from_attributes=True)
    ...
    layeredimage thot 4some fuckreona:
        attribute_function MultiPickers([ CollarPicker, PubesPicker, DickPicker], npcs=[reona], append_npc_from_attributes=True)
